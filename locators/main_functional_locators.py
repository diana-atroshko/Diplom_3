...
class MainFunctionalLocators:
    ...
    INGREDIENT_2 = [By.XPATH, "//a[p[text()='Флюоресцентная булка R2-D3']]"]
    ...
    INGREDIENT_COUNTER_2 = [By.XPATH, "//a[p[text()='Флюоресцентная булка R2-D3']]//p[contains(@class, 'counter_counter__num__3nue1')]"]
